...
return [
    ...
    'default' => [
        ...
        'log' => [
            ...
            'file' => env('WECHAT_LOG_FILE', dirname(\think\facade\Env::get('root_path')) . '/runtime/log/wechat/'),
        ],
    ],
    ...
    'official_account' => [
        'default' => [
            // AppID
            'app_id' => env('WECHAT_OFFICIAL_ACCOUNT_APPID', $json_array['wx_app_id']),
            // AppSecret
            'secret' => env('WECHAT_OFFICIAL_ACCOUNT_SECRET', $json_array['wx_secret']),
//            // Token
