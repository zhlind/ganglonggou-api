...
//工行支付回调
Route::any("api/:version/notify/gsyh_notify$",'api/:version.notify.PayNotify/gsyhPayNotify');
...
//上架广告
Route::post('api/:version/cms/cms_allow_index_ad$', 'api/:version.cms.CmsIndexAd/allowSaleIndexAd');
//预约订单
